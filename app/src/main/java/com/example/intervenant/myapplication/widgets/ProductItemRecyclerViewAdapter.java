...
public class ProductItemRecyclerViewAdapter extends RecyclerView.Adapter<ProductItemRecyclerViewAdapter.ViewHolder> {
    ...
    private final ProductFragment.OnProductItemClickListener mListener;

    public ProductItemRecyclerViewAdapter(List<Product> items, ProductFragment.OnProductItemClickListener listener) {
        mValues = items;
        mListener = listener;
    }
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != mListener) {
                    ...
                    //----mListener.onProductItemSelected(holder.mItem, );
                }
            }
        });
    }
